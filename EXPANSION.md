...
**Media IDs (District-level):**
| Class Year | Media ID | Status |
|------------|----------|--------|
| 2024 | 11180 | HTTP 200 |
| 2023 | 9887 | HTTP 200 |
| 2022 | 9888 | HTTP 200 |
...
- **Access:** Direct download
- **Notes:** Includes 4-year grad rate, 5-year grad rate, and dropout rates

**Media IDs:**
| Class Year | Media ID | Content |
|------------|----------|---------|
| 2024 | 11182 | Class 2024 4-yr, Class 2023 5-yr, 2023-24 Dropout |
| 2023 | 9893 | Class 2023 4-yr, Class 2022 5-yr, 2022-23 Dropout |
| 2022 | 9894 | Class 2022 4-yr, Class 2021 5-yr, 2021-22 Dropout |
| 2021 | 10327 | Class 2021 4-yr, Class 2020 5-yr, 2020-21 Dropout |
| 2020 | 10328 | Class 2020 4-yr, Class 2019 5-yr, 2019-20 Dropout |
...
Files have 3-4 header rows that need to be skipped:
- Row 1: Title (e.g., "Iowa Public School District Class of 2024...")
- Row 2: Notes (for corrected data) or blank
- Row 3: Subgroup names (Overall, IEP, FRL, EL, race categories, gender)
- Row 4: Column headers (County, AEA Code, etc., Numerator, Denominator, Rate)
...
**2019-2023 (44 columns, skip=4):**
Same as 2024 but WITHOUT Non-Binary category. Extra note row about data corrections.

**School-level files (49 columns for 2024):**
Same subgroups but adds: `School Code`, `School Name` after District Name.

### Schema Changes Noted
- **2024:** Added Non-Binary gender category (3 extra columns)
- **2019-2023:** Data corrected in spring 2024 (mobile student dropout issue)
...
District-level sums are approximately double (includes both reporting levels).
...
3. Handle multi-row header parsing (detect subgroup row, then column names)
...
- Grades 7-12 dropout rates
- Same subgroup breakdowns as graduation data
- Could be implemented as `fetch_dropout()` function

### Five-Year Graduation Rates
Available in the combined files, tracking students who graduate within 5 years:
- Extends the 4-year cohort tracking
- Same methodology, longer timeframe
- Class of 2023 5-year rate available in 2024 file

### Graduate Intentions Data
Separate data available on post-graduation plans:
- Years: 2001-02 through 2024-25
- Could be future expansion: `fetch_grad_intentions()`
