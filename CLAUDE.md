...
| Python tests | `pytest tests/test_pyiaschooldata.py -v`                                       | Python wrapper works correctly                 |
...
system("pip install -e ./pyiaschooldata && pytest tests/test_pyiaschooldata.py -v")
...
warnings - \[ \] `pytest tests/test_pyiaschooldata.py` — all tests
pass - \[ \]
